...
print(f"This dataset has {len(np.unique(iris_y))} labels which are Setosa, Versicolour and Virginica")
...
mlp_classifier = MLPClassifier(random_state = 1, max_iter = 1000).fit(x_train,y_train)
